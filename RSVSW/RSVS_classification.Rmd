...
Once you have clicked your five points, click on the `stop` key in the upper left corner to save your clicked points and close the function before moving on to the next step. If you make a mistake in the step, run the `chunck` again to start over.
...
dt[, class := factor(make.names(points@data$id_cls))]
